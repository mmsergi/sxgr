...
public class Token {
    ...
    public void data_Token(int id_token, String url_token, int points_token) {
        this.id = id_token;
        this.url = url_token;
...
/*        View header_aux = new RelativeLayout(this.main_activity.getBaseContext());
        ...
        createButtons(footer, img, points);
    ...
    private void createButtons(RelativeLayout footer, final ImageView imgShare , final int points_) {
        ...
        points_text.setText(main_activity.getResources().getString(R.string.puntos) + ": " + Integer.toString(points_));
        ...
        btn_UP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                points_text.setText(R.string.puntos + ": " + Integer.toString(points_ + 1));
        ...
        share_view.setText(R.string.compartir);
        ...
        shape.setColor(main_activity.getResources().getColor(R.color.btnShareColor));
                                          ...
                                          public void onClick(View v) {
                                              ...
                                              if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)) {
                                                  if (!prefs.getBoolean("permission", false)) {
                                                      ...
                                                      intent.putExtra(Intent.EXTRA_TEXT, main_activity.getResources().getString(R.string.compartirwhatsapp) + ": https://goo.gl/GPUoTJ");
                                                      String path = MediaStore.Images.Media.insertImage(main_activity.getContentResolver(), bitmapImg, "", null);
                                                      Uri screenshotUri = Uri.parse(path);

                                                      intent.putExtra(Intent.EXTRA_STREAM, screenshotUri);
                                                      intent.setType("image/*");
                                                      main_activity.startActivity(Intent.createChooser(intent, main_activity.getResources().getString(R.string.compartirintermedio) + ":"));
